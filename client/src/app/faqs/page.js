  ...
  return (
    <main className="py-12 md:py-16">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-4 font-jost" style={{ color: "#3D1C02" }}>
            Frequently Asked Questions
          </h1>
          <p className="text-lg text-center mb-12 max-w-2xl mx-auto font-roboto" style={{ color: "#7A5C3A" }}>
            Find answers to common questions about our rugs, ordering,
            shipping, and more.
          </p>
          ...
          {/* Contact section */}
          <div className="mt-16 p-8 rounded-lg text-center" style={{ backgroundColor: "#F5ECD7" }}>
            <h2 className="text-xl font-bold mb-3 font-jost" style={{ color: "#3D1C02" }}>Still have questions?</h2>
            <p className="mb-6 font-roboto" style={{ color: "#7A5C3A" }}>
            ...
            <div className="flex justify-center gap-4">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-6 py-3 border rounded-md transition-colors font-jost"
                style={{ borderColor: "#C9A84C", color: "#3D1C02" }}
              >
                Email Support
              </a>
            </div>
