// Carpet washing & care SVG icons for client rendering
...
export const WASHING_CARE_ICONS = [
  ...
  },
  {
    ...
    label: "Use Furniture Protectors",
    svg: (p) => (
      <svg {...iconProps} {...p}>
