      ...
      <Card className="border border-[#e5e0da] shadow-none bg-white rounded-none">
        <CardContent className="space-y-8 p-8 md:p-12 text-gray-800 leading-relaxed font-roboto">
          <p className="text-base font-jost tracking-wide text-gray-600">
            At Wool Jute Rug Co., we value your privacy and are committed to protecting your personal information.
          </p>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-gray-600">
              By using our website, you consent to the collection, processing, storage, and transfer of your information in accordance with applicable international privacy laws, including GDPR, UK GDPR, and other relevant data protection regulations.
            </p>
          </div>
