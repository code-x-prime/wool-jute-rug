...
export default function ChangePasswordPage() {
  ...
  // OAuth users (Google/Facebook/Twitter) don't have password - redirect to account
  useEffect(() => {
    if (!loading && isAuthenticated && user?.hasPassword === false) {
      router.replace("/account");
    }
  }, [loading, isAuthenticated, user?.hasPassword, router]);
