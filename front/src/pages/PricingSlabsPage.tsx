                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="space-y-4 py-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div className="space-y-2">
                                    <Label htmlFor="minQty">
                                        {t("pricing_slabs.form.min_qty_label")} <span className="text-[var(--destructive)]">*</span>
                                    </Label>
                                    <Input
                                        id="minQty"
                                        type="number"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="price">
                                        {t("pricing_slabs.form.price_label")} <span className="text-[var(--destructive)]">*</span>
                                    </Label>
                                    <Input
                                        id="price"
                                        type="number"
                            ...
                            {(!formData.productId && !formData.variantId) && (
                                <div className="flex gap-2 p-3 bg-[var(--text-primary)]/10 border border-[var(--text-primary)]/20 rounded-lg">
                                    <AlertCircle className="h-5 w-5 text-[var(--text-primary)] flex-shrink-0" />
