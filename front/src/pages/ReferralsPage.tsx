          ...
          <Card className="bg-[var(--bg-card)] border-[var(--border-color)] shadow-[0_1px_2px_rgba(0,0,0,0.04)] rounded-xl border-l-2 border-l-[var(--text-primary)]">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                ...
                <Clock className="h-8 w-8 text-[var(--text-primary)]" />
              </div>
            </CardContent>
          </Card>
            ...
            <div className="space-y-3">
              {stats.topReferrers.slice(0, 5).map((ref, index) => (
                <div
                  ...
                  className="flex items-center justify-between p-4 border border-[var(--border-color)] rounded-lg hover:bg-[var(--bg-secondary)] transition-colors"
                >
                  <div className="flex items-center gap-3">
                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-[var(--accent)]/10 text-[var(--accent)] font-bold">
                      {index + 1}
                    </div>
                    <div>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-sm text-[var(--accent)] flex items-center gap-1 justify-end">
      ...
      <Card className="bg-[var(--bg-card)] border-[var(--border-color)] shadow-[0_1px_2px_rgba(0,0,0,0.04)] rounded-xl">
        ...
        <CardContent>
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            ...
            <select
              className="px-4 py-2 border border-[var(--border-color)] rounded-lg focus:border-primary focus:outline-none"
              value={statusFilter}
              onChange={(e) => {
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1 space-y-4">
                          <div className="flex items-center gap-4">
                            <div>
                              <p className="text-sm text-[var(--text-secondary)]">{t('referrals_page.card.referral_code')}</p>
