      ...
      <div className="flex">
        {[...Array(5)].map((_, i) => (
          <Star
            key={i}
            className="h-4 w-4"
            fill={i < rating ? "var(--text-primary)" : "none"}
            stroke={i < rating ? "var(--text-primary)" : "currentColor"}
          />
        ))}
      </div>
    );
    ...
    <div className="space-y-8">
      ...
      {stats && (
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
          <Card className="bg-[var(--bg-card)] border-[var(--border-color)] shadow-[0_1px_2px_rgba(0,0,0,0.04)] rounded-xl border-l-2 border-l-[var(--accent)]">
          ...
          <Card className="bg-[var(--bg-card)] border-[var(--border-color)] shadow-[0_1px_2px_rgba(0,0,0,0.04)] rounded-xl border-l-2 border-l-[var(--accent)]">
            ...
            <CardContent>
              <div className="flex items-center">
                <span className="text-2xl font-bold text-[var(--text-primary)] mr-2">
          ...
          <Card className="bg-[var(--bg-card)] border-[var(--border-color)] shadow-[0_1px_2px_rgba(0,0,0,0.04)] rounded-xl border-l-2 border-l-[var(--text-primary)]">
            <CardHeader className="pb-2">
              <CardTitle className="text-xs font-medium text-[var(--text-secondary)]">
      ...
      <Card className="bg-[var(--bg-card)] border-[var(--border-color)] shadow-[0_1px_2px_rgba(0,0,0,0.04)] rounded-xl">
        <CardHeader>
          <CardTitle className="text-lg font-semibold text-[var(--text-primary)] flex items-center">
            <Filter className="h-5 w-5 mr-2 text-[var(--text-primary)]" />
        ...
        <CardContent>
          <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
            <div>
              <Label htmlFor="search" className="text-sm font-medium text-[var(--text-primary)]">
            ...
            <div>
              <Label htmlFor="rating" className="text-sm font-medium text-[var(--text-primary)]">
              ...
              >
                <SelectTrigger id="rating" className="mt-1 border-[var(--border-color)] focus:border-primary">
            ...
            <div>
              ...
              >
                <SelectTrigger id="status" className="mt-1 border-[var(--border-color)] focus:border-primary">
            ...
            <div>
              <Label htmlFor="sortBy" className="text-sm font-medium text-[var(--text-primary)]">
              ...
              <div className="flex gap-2 mt-1">
                ...
                >
                  <SelectTrigger id="sortBy" className="border-[var(--border-color)] focus:border-primary">
                ...
                >
                  <SelectTrigger id="order" className="border-[var(--border-color)] focus:border-primary">
          ...
          {isLoading && (
            <div className="flex justify-center py-20">
              <div className="flex flex-col items-center">
                ...
                <p className="mt-4 text-base text-[var(--text-secondary)]">{t("reviews.table.loading")}</p>
              </div>
            </div>
          )}
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-start gap-4 flex-1 min-w-0">
                      <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-[var(--text-primary)]/10 flex-shrink-0">
                        <Star className="h-6 w-6 text-[var(--text-primary)]" fill="var(--text-primary)" />
                      </div>
          ...
          <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-4 py-4">
              ...
              {selectedReview.adminReply && (
                <div className="bg-[var(--bg-secondary)] p-3 rounded-md mt-4">
        ...
        <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
          <DialogContent className="sm:max-w-[450px]">
            ...
            <div className="py-4">
              ...
              <div className="bg-[var(--bg-secondary)] p-3 rounded-md mt-3">
                <div className="flex items-center">
                  {renderStars(selectedReview.rating)}
