  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[var(--text-primary)]">{t("attributes.title")}</h1>
          <p className="text-sm text-[var(--text-secondary)] mt-1">
            Attributes like Size, Color, RAM help customers pick product variants. Create once, add values, then use in products.
          </p>
        </div>
        <Button asChild>
      ...
      <Card className="p-4 rounded-xl border-[var(--border-color)] bg-[var(--bg-card)]">
        <div className="mb-4 flex items-center gap-2">
          <Input
            placeholder={t("attributes.search_placeholder")}
            value={search}
            onChange={(e) => setSearch(e.target.value)}
            className="max-w-sm bg-[var(--input-bg)] border-[var(--border-color)]"
          />
          <span className="text-xs text-[var(--text-secondary)]">
            {attributesList.length} attribute{attributesList.length !== 1 ? "s" : ""}
          </span>
        </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {attributesList.map((attribute) => (
                  <tr key={attribute.id} className="border-b border-[var(--border-color)] hover:bg-[var(--bg-secondary)]/50 transition-colors">
                    <td className="px-4 py-3">
                      <div className="font-medium text-[var(--text-primary)]">{attribute.name}</div>
                    </td>
                    <td className="px-4 py-3">
...
// Carpet-specific attribute presets
const INDUSTRY_PRESETS = {
  ...
  material: {
    name: "Material",
    attributes: [
      { name: "Material", inputType: "select" },
    ],
  },
  shape: {
    name: "Shape",
    attributes: [
      { name: "Shape", inputType: "select" },
    ],
  },
  pile: {
    name: "Pile Height",
    attributes: [
      { name: "Pile Height", inputType: "select" },
    ],
  },
  pattern: {
    name: "Pattern",
    attributes: [
      { name: "Pattern", inputType: "select" },
    ],
  },
};
...
function AttributeForm({
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="p-6 rounded-xl border-[var(--border-color)] bg-[var(--bg-card)]">
            ...
            <DialogDescription className="space-y-4 pt-4 text-left">
              <div>
                ...
                <ol className="list-decimal list-inside space-y-2 text-sm">
                  ...
                  <li>
                    <strong>Quick Setup (Create Only):</strong> Use the presets
                    dropdown to quickly set up common carpet attributes. For
                    example:
                    <ul className="list-disc list-inside ml-4 mt-1 space-y-1">
                      <li>
                        <strong>Size:</strong> Carpet dimensions like 2x3, 4x6, 8x10
                      </li>
                      <li>
                        <strong>Color:</strong> Color options with hex codes and swatches
                      </li>
                      <li>
                        <strong>Material:</strong> Wool, Synthetic, Cotton, Silk, etc.
                      </li>
                    </ul>
                    After selecting a preset, click the attribute button to auto-fill the form.
                  </li>
                  <li>
              ...
              <div>
                ...
                <div className="bg-muted p-3 rounded-md text-sm space-y-2">
                  <div>
                    <strong>Example 1 - Size:</strong>
                    <ul className="list-disc list-inside ml-4 mt-1">
                      <li>Attribute: "Size" → Input Type: "Select"</li>
                      <li>Values: 2x3, 3x5, 4x6, 5x8, 6x9, 8x10, 9x12</li>
                    </ul>
                  </div>
                  <div>
                    <strong>Example 2 - Color:</strong>
                    <ul className="list-disc list-inside ml-4 mt-1">
                      <li>Attribute: "Color" → Input Type: "Select"</li>
                      <li>Values: Beige, Ivory, Navy, Red, Grey (with hex codes)</li>
                    </ul>
                  </div>
                  <div>
                    <strong>Example 3 - Material:</strong>
                    <ul className="list-disc list-inside ml-4 mt-1">
                      <li>Attribute: "Material" → Input Type: "Select"</li>
                      <li>Values: Wool, Synthetic, Cotton, Silk, Jute</li>
                    </ul>
                  </div>
                  <div>
                    <strong>Example 4 - Shape:</strong>
                    <ul className="list-disc list-inside ml-4 mt-1">
                      <li>Attribute: "Shape" → Input Type: "Select"</li>
                      <li>Values: Rectangle, Round, Runner, Square, Oval</li>
                    </ul>
                  </div>
                </div>
              </div>
