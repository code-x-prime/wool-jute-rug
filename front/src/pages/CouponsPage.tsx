...
function CouponsList() {
  ...
  // Format date with time (or date only if midnight)
  ...
  if (error) {
    return (
      <div className="flex h-full w-full flex-col items-center justify-center py-20">
        ...
        <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-1.5">{t('coupons.error_title')}</h2>
        ...
        <Card className="bg-[var(--bg-card)] border-[var(--border-color)] shadow-[0_1px_2px_rgba(0,0,0,0.04)] rounded-xl">
          <div className="text-center py-16">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-[var(--bg-secondary)] mb-4">
              <Ticket className="h-8 w-8 text-[var(--text-secondary)]" />
            </div>
                ...
                <div className="flex items-start justify-between gap-4 mb-4">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    {coupon.isActive ? (
                      ...
                      <Badge className="bg-[var(--bg-secondary)] text-[var(--text-secondary)] border-[var(--border-color)] text-xs font-medium">
                ...
                <div className="space-y-3 mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    {coupon.discountType === "PERCENTAGE" ? (
                      <>
                        <PercentIcon className="h-4 w-4 text-[var(--accent)]" />
                  ...
                  {coupon.couponPartners && coupon.couponPartners.length > 0 && (
                    <div className="flex flex-wrap items-center gap-2">
                      <UserPlus className="h-4 w-4 text-[var(--text-secondary)] shrink-0" />
                      {coupon.couponPartners.map((cp, i) => (
                        <span
                          key={cp.partner?.id || i}
                          className="inline-flex items-center gap-1.5 text-sm text-[var(--text-primary)] bg-[var(--bg-secondary)] px-2.5 py-1 rounded-lg"
                        >
                          <span className="font-medium">{cp.partner?.name || "—"}</span>
                          {cp.commission != null && (
...
function CouponForm({
  ...
  const validateForm = () => {
    ...
    if (!formData.startDate) {
      setError(t('coupons.messages.start_date_required'));
      return false;
    }
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <Label htmlFor="code" className="text-sm font-medium text-[var(--text-primary)]">
                  {t('coupons.form.code')} <span className="text-[var(--destructive)]">*</span>
                </Label>
                <Input
                  id="code"
                  name="code"
        ...
        <Card className="bg-[var(--bg-card)] border-[var(--border-color)] shadow-[0_1px_2px_rgba(0,0,0,0.04)] rounded-xl">
          ...
          <CardContent className="px-6 pb-6 space-y-5">
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                <Label htmlFor="discountType" className="text-sm font-medium text-[var(--text-primary)]">
                  {t('coupons.form.discount_type')} <span className="text-[var(--destructive)]">*</span>
                </Label>
                <select
                  id="discountType"
                  name="discountType"
                  ...
                  onChange={handleInputChange}
                  className="flex h-10 w-full rounded-lg border border-[var(--border-color)] bg-[var(--bg-secondary)] px-3 py-2 text-sm text-[var(--text-primary)] focus:border-primary focus:outline-none"
                  required
                >
              ...
              <div className="space-y-2">
                <Label htmlFor="discountValue" className="text-sm font-medium text-[var(--text-primary)]">
                  {t('coupons.form.discount_value')} <span className="text-[var(--destructive)]">*</span>
                </Label>
                <div className="flex">
                  <div className="flex items-center rounded-l-lg border border-r-0 border-[var(--border-color)] bg-[var(--bg-secondary)] px-3">
                    {formData.discountType === "PERCENTAGE" ? (
                      <PercentIcon className="h-4 w-4 text-[var(--text-secondary)]" />
                    ) : (
                      <IndianRupee className="h-4 w-4 text-[var(--text-secondary)]" />
                    )}
                  </div>
                  <Input
                    id="discountValue"
                    ...
                    className={
                      error && error.includes("Discount value")
                        ? "border-[var(--destructive)] ring-1 ring-[var(--destructive)] rounded-l-none"
                        : "border-[var(--border-color)] focus:border-primary rounded-l-none"
                    }
                    required
                  />
                </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="minOrderAmount" className="text-sm font-medium text-[var(--text-primary)]">
                ...
                <div className="flex">
                  ...
                  <Input
                    ...
                    onChange={handleInputChange}
                    className="border-[var(--border-color)] focus:border-primary rounded-l-none"
                  />
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="maxUses" className="text-sm font-medium text-[var(--text-primary)]">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <MultiSelectCombo
                  ...
                  maxHeight={240}
                />
                <p className="text-xs text-[var(--text-secondary)]">{t('coupons.form.target_hint_categories')}</p>
              </div>
              ...
              <div className="space-y-2">
                <MultiSelectCombo
                  ...
                  maxHeight={240}
                />
                <p className="text-xs text-[var(--text-secondary)]">{t('coupons.form.target_hint_products')}</p>
              </div>
              ...
              <div className="space-y-2">
                <MultiSelectCombo
                  ...
                  maxHeight={240}
                />
                <p className="text-xs text-[var(--text-secondary)]">{t('coupons.form.target_hint_brands')}</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                <Label className="text-sm font-medium text-[var(--text-primary)]">
                  {t('coupons.form.start_date')} <span className="text-[var(--destructive)]">*</span>
                </Label>
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                      className={cn(
                        "w-full justify-start text-left font-normal border-[var(--border-color)] hover:bg-[var(--bg-secondary)]",
                        !formData.startDate && "text-[var(--text-secondary)]"
                      )}
                    >
                      <CalendarIcon className="mr-2 h-4 w-4 text-[var(--text-secondary)]" />
                      {formData.startDate
                        ? format(new Date(formData.startDate), "PPP")
                        : t('coupons.form.select_start_date')}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0 bg-[var(--bg-card)] border-[var(--border-color)]" align="start">
                    <Calendar
                      ...
                      onSelect={(d) => d && setFormData({ ...formData, startDate: format(d, "yyyy-MM-dd") })}
                      initialFocus
                    />
                  </PopoverContent>
                </Popover>
              ...
              <div className="space-y-2">
                <Label className="text-sm font-medium text-[var(--text-primary)]">
                  {t('coupons.form.end_date')} <span className="text-[var(--text-secondary)]">(Optional)</span>
                </Label>
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        "w-full justify-start text-left font-normal border-[var(--border-color)] hover:bg-[var(--bg-secondary)]",
                        !formData.endDate && "text-[var(--text-secondary)]"
                      )}
                    >
                      <CalendarIcon className="mr-2 h-4 w-4 text-[var(--text-secondary)]" />
                      {formData.endDate
                        ? format(new Date(formData.endDate), "PPP")
                        : t('coupons.form.select_end_date')}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0 bg-[var(--bg-card)] border-[var(--border-color)]" align="start">
                    <Calendar
                      ...
                      onSelect={(d) => d && setFormData({ ...formData, endDate: format(d, "yyyy-MM-dd") })}
                      disabled={(d) => formData.startDate ? d < new Date(formData.startDate) : false}
                      initialFocus
                    />
                  </PopoverContent>
                </Popover>
        ...
        <Card className="bg-[var(--bg-card)] border-[var(--border-color)] shadow-[0_1px_2px_rgba(0,0,0,0.04)] rounded-xl">
          ...
          <CardContent className="px-6 pb-6 space-y-5">
            ...
            {selectedPartners.length === 0 ? (
              <div className="text-center p-6 border-2 border-dashed border-[var(--border-color)] rounded-lg bg-[var(--bg-secondary)]">
              ...
              <div className="space-y-3">
                {selectedPartners.map((partner, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-3 p-4 border border-[var(--border-color)] rounded-lg bg-[var(--bg-secondary)]"
                  >
                    <div className="flex-1 space-y-2">
                      <select
                        ...
                        className={`flex h-10 w-full rounded-lg border px-3 py-2 text-sm ${error &&
                          ...
                          ? "border-[var(--destructive)] ring-1 ring-[var(--destructive)] bg-[var(--bg-card)]"
                          : "border-[var(--border-color)] bg-[var(--bg-card)] focus:border-primary focus:outline-none"
                          }`}
                      >
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex">
                        ...
                        <Input
                          ...
                          className="w-20 border-[var(--border-color)] focus:border-primary rounded-l-none"
                        />
                      </div>
                      ...
                      <Button
                        ...
                        className="h-10 w-10 hover:bg-[var(--destructive)]/10"
                      >
            ...
            <div className="bg-[var(--accent)]/10 border border-[var(--accent)]/30 rounded-xl p-4">
              <div className="flex items-start gap-3">
                <AlertTriangle className="h-5 w-5 text-[var(--accent)] flex-shrink-0 mt-0.5" />
                <div className="flex-1">
