            ...
            <DialogDescription className="space-y-4 pt-4">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-sm">
                  <li>
                    <strong>Size:</strong> 2x3, 4x6, 5x8, 8x10, 9x12 (feet dimensions)
                  </li>
                  <li>
                    <strong>Color:</strong> Beige, Ivory, Navy Blue, Charcoal, Rust, etc.
                    Add hex code for color swatch preview
                  </li>
                  <li>
                    <strong>Material:</strong> Wool, Synthetic, Cotton, Silk, Jute, Viscose
                  </li>
                  <li>
                    <strong>Shape:</strong> Rectangle, Round, Runner, Square, Oval
                  </li>
                  <li>
                    <strong>Pile Height:</strong> Low Pile, Medium Pile, High Pile, Flat Weave, Shaggy
                  </li>
                  <li>
                    <strong>Pattern:</strong> Geometric, Floral, Traditional, Modern, Abstract
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-sm">
                  Use the "Quick Add" dropdown to quickly add common carpet values for
                  Size, Color, Material, Shape, Pile Height, and Pattern attributes.
                  Saves time when creating multiple values.
                </p>
              </div>
...
function AttributeValueForm({
  ...
  // Preset values for carpet attributes
  ...
  > = {
    ...
    color: [
      ...
      { value: "Ivory", hexCode: "#FFFFF0" },
      { value: "Cream", hexCode: "#FFFDD0" },
      { value: "Off White", hexCode: "#FAF9F6" },
      { value: "Light Grey", hexCode: "#D3D3D3" },
      { value: "Grey", hexCode: "#808080" },
      { value: "Charcoal", hexCode: "#36454F" },
      { value: "Navy Blue", hexCode: "#000080" },
      { value: "Blue", hexCode: "#0047AB" },
      { value: "Teal", hexCode: "#008080" },
      { value: "Brown", hexCode: "#795548" },
      { value: "Tan", hexCode: "#D2B48C" },
      { value: "Rust", hexCode: "#B7410E" },
      { value: "Burgundy", hexCode: "#800020" },
      { value: "Red", hexCode: "#CC0000" },
      { value: "Terracotta", hexCode: "#E2725B" },
      { value: "Sage Green", hexCode: "#B2AC88" },
      { value: "Olive", hexCode: "#808000" },
      { value: "Mustard", hexCode: "#FFDB58" },
      { value: "Black", hexCode: "#000000" },
      { value: "White", hexCode: "#FFFFFF" },
      { value: "Multi Color", hexCode: "#9B59B6" },
    ],
    material: [
      { value: "Wool" },
      { value: "Pure Wool" },
            ...
            <Input
              ...
              placeholder={
                attribute?.inputType === "number"
                  ? "e.g., 2x3, 4x6, 8x10"
                  : isColorAttribute
                    ? "e.g., Beige, Ivory, Navy Blue"
                    : isSizeAttribute
                      ? "e.g., 2x3, 4x6, 8x10, 9x12"
                      : "e.g., Wool, Rectangle, Geometric"
              }
              required
            />
            <p className="text-sm text-muted-foreground">
