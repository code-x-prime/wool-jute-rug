          ...
          <div className="flex items-center gap-3">
            <div className="relative flex-1 max-w-sm">
              ...
              <Input
                ...
                className="pl-9 rounded-full border-[var(--border-color)] bg-[var(--bg-card)] focus:border-primary"
                value={searchQuery}
                ...
                >
                      ...
                      {imagePreview ? (
                        <div className="space-y-2">
                          <img
                            ...
                            className="mx-auto h-24 w-24 object-contain rounded-lg border border-[var(--border-color)]"
                          />
                  ...
                  <div className="flex gap-3 pt-2">
                    <Button
                      type="button"
                      variant="outline"
                      className="flex-1 border-[var(--border-color)] hover:bg-[var(--bg-secondary)]"
              ...
              >
                ...
                <div className="flex-shrink-0">
                  <img
                    ...
                    alt={brand.name}
                    className="h-16 w-16 object-contain rounded-lg border border-[var(--border-color)] bg-[var(--bg-secondary)] p-2"
                  />
                </div>
                  ...
                  <div className="flex items-start justify-between gap-4">
                        ...
                        {brand.tags && brand.tags.length > 0 && (
                          <div className="flex items-center gap-1.5 flex-wrap">
                            {brand.tags.map((tag) => (
                              <Badge
                                key={tag}
                                className="bg-[var(--accent)]/20 text-[var(--accent)] border-[var(--accent)]/30 text-xs"
                              >
                    ...
                    <div className="hidden lg:flex items-center gap-3 flex-shrink-0">
                      <Button
                        variant="outline"
                        size="sm"
                        className="border-[var(--border-color)] hover:bg-[var(--bg-secondary)] text-sm"
        ...
        <div className="flex items-center gap-2 mb-4">
          <div className="relative flex-1">
            ...
            <Input
              ...
              className="pl-9 border-[var(--border-color)] focus:border-primary"
            />
          </div>
        </div>
        {loading ? (
          ...
          <div className="max-h-80 overflow-y-auto border border-[var(--border-color)] rounded-xl">
            <div className="divide-y divide-[var(--border-color)]">
              {allProducts.map((product) => (
                <div
                  key={product.id}
                  className="flex items-center gap-3 p-3 hover:bg-[var(--bg-secondary)] transition-colors"
                >
                  <input
                    type="checkbox"
                    className="h-4 w-4 rounded border-[var(--border-color)] text-[var(--accent)] focus:ring-[var(--accent)]"
                  ...
                  <img
                    ...
                    alt={product.name}
                    className="h-10 w-10 object-contain rounded-lg border border-[var(--border-color)] bg-[var(--bg-secondary)]"
                  />
                  <div className="flex-1 min-w-0">
